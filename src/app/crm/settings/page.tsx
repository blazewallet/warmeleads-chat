          ...
          <div className="space-y-6">
            <div className="bg-white/5 rounded-xl p-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h3 className="font-medium text-white">Automatische WhatsApp Berichten</h3>
                  <p className="text-sm text-white/70">Verstuur automatisch WhatsApp berichten naar nieuwe leads</p>
                </div>
                <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-white/5 rounded-lg p-4">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <span className="text-sm font-medium text-white">Warmeleads WhatsApp</span>
                ...
                <div className="bg-white/5 rounded-lg p-4">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <span className="text-sm font-medium text-white">Eigen WhatsApp</span>
            ...
            <div className="bg-gradient-to-r from-green-500/20 to-blue-500/20 rounded-xl p-6 border border-green-500/30">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-medium text-white mb-1">💬 Automatische Lead Berichten</h4>
